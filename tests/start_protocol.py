#python3 tests/start_protocol.py --host localhost --position X1 --sample-id "my_sample" --experiment-group "my_group" --experiment-duration 24 --kit SQK-LSK109 --basecalling --fastq --bam
